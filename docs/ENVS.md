...
- [Run-time environment variables](#run-time-environment-variables)
  ...
  - [UI configuration](#ui-configuration)
    ...
    - [Featured networks](#featured-networks)
      ...
      - [Navigation promo banner configuration properties](#navigation-promo-banner-configuration-properties)
        - [Text promo banner:](#text-promo-banner)
        - [Image promo banner:](#image-promo-banner)
    - [Footer](#footer)
  ...
  - [App features](#app-features)
    ...
    - [Marketplace](#marketplace)
      ...
      - [Essential dapps configuration properties](#essential-dapps-configuration-properties)
    ...
    - [Flashblocks](#flashblocks)
      - [Address 3rd party widget](#address-3rd-party-widget)
      - [Address 3rd party widget configuration properties](#address-3rd-party-widget-configuration-properties)
    - [ZetaChain cross-chain transactions](#zetachain-cross-chain-transactions)
      - [ZetaChain supported cain configuration properties](#zetachain-supported-cain-configuration-properties)
    - [Multichain explorer](#multichain-explorer)
    - [Badge claim link](#badge-claim-link)
    - [Puzzle game badge claim link](#puzzle-game-badge-claim-link)
  - [External services configuration](#external-services-configuration)
    - [Google ReCaptcha](#google-recaptcha)
    - [DCL Dashboard](#dcl-dashboard)
...
| Variable | Type| Description | Compulsoriness  | Default value | Example value | Version |
| --- | --- | --- | --- | --- | --- | --- |
| NEXT_PUBLIC_DCL_DASHBOARD_ENABLED | `boolean` | Enables Vana DCL Dashboard | - | - | `true` | - |
| NEXT_PUBLIC_DCL_DASHBOARD_URL | `string` | Dashboard URL | - | - | `https://example.com` | - |
